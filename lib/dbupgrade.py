...
def upgrade_database(self, version, config):
    ...
    if version == 0 or version is None:
        ...
        db.tables.media.insert(bind=b).execute(name='1080p HD Widescreen')
        db.tables.media.insert(bind=b).execute(name='1080p SD')
        db.tables.media.insert(bind=b).execute(name='Ultrawide HD')
        db.tables.media.insert(bind=b).execute(name='Super Ultrawide')
        db.tables.media.insert(bind=b).execute(name='Rec. 601')
        db.tables.media.insert(bind=b).execute(name='Full HD+')
        db.tables.media.insert(bind=b).execute(name='File')
        db.tables.media.insert(bind=b).execute(name='1080p BluRay File')
        db.tables.media.insert(bind=b).execute(name='720p BluRay File')
        db.tables.media.insert(bind=b).execute(name='4K, UHD, Ultra HD, Ultra-High Definition DVD')
        ...
        db.tables.acodecs.insert(bind=b).execute(name='FLAC')
        db.tables.acodecs.insert(bind=b).execute(name='MP4')
        db.tables.acodecs.insert(bind=b).execute(name='MKV')
        db.tables.acodecs.insert(bind=b).execute(name='3GP')
        ...
        db.tables.vcodecs.insert(bind=b).execute(name='H.265')
        db.tables.vcodecs.insert(bind=b).execute(name='MPEG-4 (mp4)')
        db.tables.vcodecs.insert(bind=b).execute(name='Matroska (mkv)')
        ...
        db.tables.subformats.insert(bind=b).execute(name='Embedded')
        ...
        db.tables.languages.insert(bind=b).execute(name=_('Filipino (Tagalog)'))
        db.tables.languages.insert(bind=b).execute(name=_('Mandarin'))
        db.tables.languages.insert(bind=b).execute(name=_('Thai'))
        db.tables.languages.insert(bind=b).execute(name=_('Persian'))
        db.tables.languages.insert(bind=b).execute(name=_('Sudanese'))
        db.tables.languages.insert(bind=b).execute(name=_('Romanian'))
        db.tables.languages.insert(bind=b).execute(name=_('Kurdish'))
        db.tables.languages.insert(bind=b).execute(name=_('Hindi'))
        db.tables.languages.insert(bind=b).execute(name=_('Dari'))
        db.tables.languages.insert(bind=b).execute(name=_('Urdu'))
        db.tables.languages.insert(bind=b).execute(name=_('Min Nan'))
        db.tables.languages.insert(bind=b).execute(name=_('Cantonese'))
        db.tables.languages.insert(bind=b).execute(name=_('British'))
        db.tables.languages.insert(bind=b).execute(name=_('Swiss German'))
        db.tables.languages.insert(bind=b).execute(name=_('Arabic'))
        db.tables.languages.insert(bind=b).execute(name=_('Hebrew'))
        db.tables.languages.insert(bind=b).execute(name=_('Yiddish'))
        db.tables.languages.insert(bind=b).execute(name=_('Dyula'))
        db.tables.languages.insert(bind=b).execute(name=_('Finnish'))
        db.tables.languages.insert(bind=b).execute(name=_('Vietnamese'))
        db.tables.languages.insert(bind=b).execute(name=_('Chinese'))
        db.tables.languages.insert(bind=b).execute(name=_('Flemish'))
        db.tables.languages.insert(bind=b).execute(name=_('Lithuanian'))
        db.tables.languages.insert(bind=b).execute(name=_('Hokkien'))
        db.tables.languages.insert(bind=b).execute(name=_('Mari'))
        db.tables.languages.insert(bind=b).execute(name=_('Ukranian'))
        db.tables.languages.insert(bind=b).execute(name=_('Bengali'))
        db.tables.languages.insert(bind=b).execute(name=_('Latvian'))
        db.tables.languages.insert(bind=b).execute(name=_('Croatian'))
        db.tables.languages.insert(bind=b).execute(name=_('Spanish (European)'))
        db.tables.languages.insert(bind=b).execute(name=_('Spanish (Latin American)'))
        db.tables.languages.insert(bind=b).execute(name=_('Assamese'))
        db.tables.tags.insert(bind=b).execute(name=_('Favourite'))
        db.tables.tags.insert(bind=b).execute(name=_('Buy me'))
        db.tables.tags.insert(bind=b).execute(name=_('Watch me'))
        db.tables.tags.insert(bind=b).execute(name=_('Has won awards'))
        db.tables.tags.insert(bind=b).execute(name=_('English with subtitle(s)'))
        db.tables.tags.insert(bind=b).execute(name=_('Non-English without subtitle(s)'))
        db.tables.tags.insert(bind=b).execute(name=_('Non-English with no subtitle(s)'))
